...
2.  To make Communication between UserA and UserB
    ...
    Yes -> 1. Check if the Room already Exists between UserA and UserB 2. If Yes -> Dont Create a Room 3. If No -> Create a Room 4. If user send Message I need to store them
